...
One of the main challenges of this project was handling user input and ensuring that the area calculation is accurate for decimal values. Using Scanner.nextDouble() for input allows the program to accept floating-point numbers, making the calculations more precise.
